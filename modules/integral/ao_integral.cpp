...
int main(int argc, char* argv[])
{
    ...
    libint2::init();
//    libint2::BasisSet obs = zezfio2obs(zezfio_socket);
//
...
//    nuclear_engine.set_params(atoms); // atoms specifies the charge and position of each nucleus
//
//    for(auto s1=0; s1!=obs.size(); ++s1) {
//      for(auto s2=0; s2!=obs.size(); ++s2) {
//    
//        std::cout << "compute shell set {" << s1 << "," << s2 << "} ... ";
//        const auto* ints_shellset = overlap_engine.compute(obs[s1], obs[s2]);
